...
const Hero:React.FC = () => {
    ...
    return (
        ...
        <div className="relative grid grid-rows-3 grid-cols-3 h-[85vh] bg-sauvignon-cr">
            ...
            <div className="text-center col-start-1 col-span-3 row-start-2 m-auto w-3/5 max-w-[60rem] flex flex-col gap-5 
                md:gap-9 items-center text-white z-0">
                <h1 
                    className="text-5xl sm:text-7xl leading-tight xl:text-7xl font-serif font-bold"
        
                    >Traditional and Modern Styles To Suit All
                    <span className="block text-2xl md:text-4xl mt-5 font-normal">Browse through our collection
                    </span>
                ...
                <Link to="/collection/kurtas">
                        <Button 
                            styles="text-lg py-3 px-4 md:px-6 md:py-5 md:text-2xl border-2">
                            SHOP NOW
                        </Button>
