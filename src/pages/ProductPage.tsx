...
const ProductPage:React.FC = () => {
    ...
    return(
        <div className="w-full">
            ...
            <article className="flex flex-col w-11/12 mx-auto mt-3 gap-3 px-5 py-5 md:flex-row lg:gap-8 md:justify-center border-2">

                <div className="flex w-full lg-2:w-1/2 items-start">
                    <img src={url![0]} alt="current item" className="object-contain w-full aspect-square"/>
                </div>

                <div className="flex flex-col gap-3 lg:items-start lg:gap-10 lg-2:w-1/3">
