...
const ProductPg:React.FC = () => {
    ...
    return(
        <div 
            className="w-full h-full bg-sauvignon-cr"
            ...
            <BreadCrumbs  />
                ...
                <motion.article 
                    ...
                    <motion.div 
                        ...
                        variants={img}
                        >
                        <img src={url![0]} alt="current item" className="object-cover w-full"/>
                    </motion.div>
                    ...
                    <motion.div 
                        ...
                        variants={text}
                        >
                        <h1 className="text-2xl lg:text-4xl font-bold font-serif md:text-start">{name}</h1>
                        <span className="text-xl lg:text-2xl font-semibold md:text-start lg:mb-2">£{price}</span>  

                        <div className="grid gap-5 font-sans-serif md:mx-0 md:mr-auto mt-3 lg:mb-12">
                            <h3 className="lg:text-lg ">Select Size</h3>         
                            <div className="flex flex-wrap flex-row gap-3">
                                <Button styles="p-2 border-2 rounded-full w-12 border-blue-card rounded-md">S</Button>
                                <Button styles="p-2 border-2 rounded-full w-12 border-blue-card rounded-md">M</Button>
                                <Button styles="p-2 border-2 rounded-full w-12 border-blue-card rounded-md">L</Button>
                                <Button styles="p-2 border-2 rounded-full w-12 border-blue-card rounded-md">XL</Button>
                                <Button styles="p-2 border-2 rounded-full w-12 border-blue-card rounded-md">XXL</Button>
                            </div>
                        </div>
