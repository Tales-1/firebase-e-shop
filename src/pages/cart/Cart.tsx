...
import { selectCart, removeFromCart, increment, decrement, selectTotal } from "../../redux/features/cartSlice"
    ...
    return(
        <div className="w-full flex flex-col items-center">
            ...
            <>
                ...
                <h1 className="font-bold text-4xl font-serif mt-4 text-center">Shopping Cart</h1>
                <main className="w-11/12 lg:w-7/12 flex flex-col gap-5 items-center justify-center h-full">
                    ...
                    {desktop && <article className="flex flex-col items-end self-end gap-4 w-2/3 lg-2:w-1/4 bg-white mt-6 rounded-md ">
